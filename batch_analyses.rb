...
begin
    ...
    relPathString = ("~/Desktop/BatchAnalyses")
    ...
    for file in filenames
        ...
        # Begin Amount of time participant is on-topic relative to their own speaking duration --------------------------------------------------------------
            ...
            # Obtain on-topic and off-topic participant durations by checking participant cells against speaker/listener cells
            ...
            #puts "Participant OT: " + (participantOT/1000).to_s
            #puts "Participant Duration: " + (partDur/1000).to_s
            #puts "Percentage: " + (participantOT/partDur).to_s 
            #puts "Percentage over On/Off Topic Duration: " + (participantOT/(participantOT + participantOFFT)).to_s
